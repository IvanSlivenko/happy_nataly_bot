...
from config import HAPPYTAA_TOKEN
from config import HAPPY_NATALY_TOKEN
...
url_happy_taa_1='https://www.actforhealth.in.ua'
url_happy_taa_2='https://3piroga.ua/blog/luchshie-sovetu-dlya-schastlivoj-semejnoj-zhizni'
url_happy_taa_3='https://forbes.ua/ru/richest/desyat-naybagatshikh-lyudey-svitu-za-versieyu-forbes-lyutiy-2024-lider-reytingu-znovu-zminivsya-01022024-18919'
url_happy_taa_4='https://tangotravel.com.ua/krainy/usa/'
url_happy_taa_5='https://toyota.com.ua'
url_happy_taa_6='https://mukachevo.net/post/95-hromadian-ne-zbyraiutsia-pereyizdzaty-z-ukrayiny-pislia-zavershennia-viyny_3472016.html'


bot = telebot.TeleBot(HAPPY_NATALY_TOKEN)
...
def go_to_site(message):
    ...
    file = open('./images/nataly_1.jpg','rb')    
    bot.send_photo(message.chat.id, file, caption=f'{message.from_user.first_name} - вітаємо з Днем народження\n Вам вже надіслано\n привітальне відео\n зачекайте будь-ласка :')


    # markup = types.InlineKeyboardMarkup()
    # markup.add(types.InlineKeyboardButton('Завершення війни в Україні  💯', url=url_happy_taa_6))
    # markup.add(types.InlineKeyboardButton('Бути здоровим 🥤', url=url_happy_taa_1))
    # markup.add(types.InlineKeyboardButton('Бути коханим 💋', url=url_happy_taa_2))
    # markup.add(types.InlineKeyboardButton('Бути шанованим 🐳', url=url_happy_taa_3))
    # markup.add(types.InlineKeyboardButton('Подорож до США 🤠', url=url_happy_taa_4))
    # markup.add(types.InlineKeyboardButton('Нове авто 🏎️', url=url_happy_taa_5))
    # markup.add(types.InlineKeyboardButton('Багато грошей  💲 💵 💲', url=url_Bild_Expr))
    ...
    # bot.send_message(message.chat.id, 'Яку мрію ви хочете здійснити ?', reply_markup=markup)

    # file_2 = open('./images/vinny.mp3','rb')    
    # bot.send_video(message.chat.id, file_2, caption=f'{message.from_user.first_name} музичний супровід для настрою')


    file_3 = open('./images/video_kozaku.mp4','rb')    
    bot.send_video(message.chat.id, file_3, caption=f'{message.from_user.first_name} - вітаємо з Днем народження')
